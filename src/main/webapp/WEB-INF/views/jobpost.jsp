                ...
                <div class="col-lg-11 no-paddin-xs">
                    ...
                    <div class="profile-info col-sm-9 " >
                        ...
                        <div class="panel animated fadeInDown delay-05s col-lg-12 " id="panel-1">
                            <div class="pull-left">
                                <a href="addjobcircularpage"><button id="addjob"
                                        ...
                                        <div id="collapse{{x.jobid}}" class="panel-collapse collapse ">
                                            <div class="panel-body">
                                                ...
                                                <td class="BDJNormalText04" align="left" valign="middle">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="edituserjobcircular?getpid={{x.jobid}}"><button  id="editjob"
                                                                                                                  type="submit" class="btn">edit</button></a>
                                                        
                                                <a href="removejobcircular/{{x.jobid}}"><button  id="removebuttons" type="button" class="btn">Remove</button></a>
                                                       
                                                <a href="showjobrespons?getpid={{x.jobid}}"><button  id="applylist" type="button" class="btn">Apply List</button></a>
