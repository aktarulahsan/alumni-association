        ...
        <nav class="navbar navbar-default navbar-fixed-top navbar-principal">
                <div class="container">
                    ...
                    <div id="navbar" class="collapse navbar-collapse nav_menu">
                        ...
                        <form:form   modelAttribute="friendlist" action="searchfriend" method="post" enctype="multipart/form-data">
                            <form:input type="text" path="firstname" placeholder="Search your Friend name ..."/>
                        </form:form>
                    </div>
        ...
        <div class="container" style="margin-top:50px;">
                                            ...
                                            <li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-3 text-right">
                                                        <a href="aboutsfrind?getpid={{nf.emailid}}"><btn class="btn btn-sm btn-info btn-icon"><i class="fa fa-user-plus"></i></btn></a>
                    ...
                    <div class="profile-info col-md-8  animated fadeInUp">
                        ...
                        <div class="panel">
                            ...
                            <form:form name="addblog"
                                       modelAttribute="addblogobject1" action="addblogpostinstuhome" enctype="multipart/form-data"
                                       method="post">
            ...
            <div class="chat-sidebar focus">
                ...
                <div class="list-group text-left">
                    ...
                    <p class="text-center visible-xs">Hide</a></p> 
                        ...
                        <tr ng-repeat="chat in clo">
                            ...
                            <td>
                                <ul class="list-inline">                    
                                    ...
                                    <a href="aboutsfrind?getpid={{chat.emailid}}">
