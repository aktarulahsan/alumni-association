                ...
                <div class="col-lg-11 no-paddin-xs">
                    ...
                    <div class="profile-info col-sm-9 " >
                        ...
                        <div class=" animated fadeInDown delay-05s col-lg-12 " id="panel-1">
                            <div class="pull-left">
                                <a href="addeditusereventstu"><button id="addjob"
                                        ...
                                        <div id="collapse{{x.eventid}}" class="panel-collapse collapse ">
                                            <div class="panel-body">
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" >
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="editusereventstu?getpid={{x.eventid}}"><button  id="editjob"
                                                                                                                  type="submit" class="btn">edit</button></a>
                                                        
                                                <a href="removeeventstu/{{x.eventid}}"><button  id="removebuttons" type="button" class="btn">Remove</button></a>
                                                       
                                                <a href="showeventresponsinfostu?getpid={{x.eventid}}"><button  id="removebuttons" type="button" class="btn">Apply List</button></a>
