  ...
  <script src="resources/js/angular.js"></script>
        <script>
            ...
            angular.module('myapp', []).controller('BlogpostController', function ($scope) {
                ...
                $scope.education = edu;
                $scope.jobcircularlist = jobpostsss;
...
<!--All user --><!--All user --><!--All user --><!--All user --><!--All user --><!--All user --><!--All user --><!--All user -->
  ...
  <div class="content-wrapper">
     <div class="row">
         ...
         <div class="col-md-6" ng-repeat="job in jobcircularlist">
          <div class="box box-solid">
            <div class="box-header with-border">
              <i class="fa fa-text-width"></i>

              <h3 class="box-title">Job Circular {{$index + 1}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <dl class="dl-horizontal">
                ...
                <dd><a onclick="clickJObTitle()" target="_blank" href="http://localhost:8080/alumni/viewonejobcircularadmin?getpid={{job.jobid}}">
                        {{job.title}}
                    </a>
                </dd>
                <dt>Company Names</dt>
                <dd>{{job.companynames}}</dd>
                
                <dt>Vacancy</dt>
                <dd>{{job.vacancy}}</dd>
                <dt>Job Description</dt>
                <dd>{{job.jobdescription}}
                </dd>
              </dl>
            </div>
            <!-- /.box-body -->
