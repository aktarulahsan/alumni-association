...
<!--All user --><!--All user --><!--All user --><!--All user --><!--All user --><!--All user --><!--All user --><!--All user -->
  ...
  <div class="content-wrapper">
     <div class="row">
         ...
         <div class="col-md-6" ng-repeat="eve in eventlists">
          <div class="box box-solid">
            <div class="box-header with-border">
              <i class="fa fa-text-width"></i>

              <h3 class="box-title">Event {{$index + 1}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <dl class="dl-horizontal">
                <dt>Event Title</dt>
                <dd><a onclick="clickEvent()" target="_blank" href="http://localhost:8080/alumni/showoneeventadmin?getpid={{eve.eventid}}">
                        {{eve.title}} 
                    </a>
                </dd>
                <dt>Contact person</dt>
                <dd>{{eve.contactparson}}</dd>
