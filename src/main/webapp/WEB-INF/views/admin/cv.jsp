        ...
        <div align="center">
            ...
            <tr>
                <td width="50%" height="" align="left" valign="bottom" class="BDJApplicantsName">
                    <!--Applicant's Name:-->
                    <h1><b><u>${profileobject1.firstname} ${profileobject1.lastname}</u></b><a href="reportView?getpid=${profileobject1.emailid}" class="glyphicon glyphicon-print pull-right"></a> </h1>   
                    ...
                    <table width="140" height="140" border="0" align="center" cellpadding="0" cellspacing="7" bgcolor="#dadce1">
                        <tbody><tr> 
                                <td width="126" height="135" align="center" bgcolor="#e2e4e5" valign="middle"> 
                                    <img src="resources/profileimage/${profileobject1.emailid}.jpg" alt="Image" width="124" height="135">
