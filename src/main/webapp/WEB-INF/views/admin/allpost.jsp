    ...
    <!-- /.sidebar -->
            ...
            <div class="content-wrapper">
                <div class="row" >
                    ...
                    <div class="col-md-6" ng-repeat="post in allbloglist">
                        <!-- Box Comment -->
                        <div class="box box-widget">
                            <div class="box-header with-border">
                                <div class="user-block">
                                    <img class="img-circle" src="resources/profileimage/{{post.emailid}}.jpg" alt="User Image">
                                    <span class="username"><a href="#">{{post.emailid}}</a></span>
                                    <span class="description">{{post.postdate}}</span>
                                </div>
                                <!-- /.user-block -->
                                <div class="box-tools">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <img class="img-responsive pad" src="resources/blogimg/{{post.picname}}.jpg" alt="">
                            ...
                            <div class="box-footer box-comments">
                                <div class="box-comment" ng-repeat="co in post.comments">
                                    <!-- User image -->
                                    <img class="img-circle img-sm" src="resources/profileimage/{{co.emailid}}.jpg" alt="User Image">

                                    <div class="comment-text">
                                        <span class="username">
                                            Maria Gonzales
                                            <span class="text-muted pull-right">{{co.commentdate}}</span>
                                        </span>
                                        {{co.comments}}
                                    </div>
                                    <!-- /.comment-text -->
