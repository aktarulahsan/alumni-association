    ...
    <!-- /.sidebar -->
            ...
            <div class="content-wrapper">
                <div class="row" >
                    ...
                    <div></div>
                    <div class=" animated fadeInDown delay-05s col-md-10 " id="panel-1">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" >
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="editusereventadmin?getpid=${viewonevent.eventid}"><button  id="editjob"
                                                                                                                  type="submit" class="btn">edit</button></a>
                                                        
                                                <a href="removeeventadmin/{{viewonevent.eventid}}"><button  id="removebuttons" type="button" class="btn">Remove</button></a>
