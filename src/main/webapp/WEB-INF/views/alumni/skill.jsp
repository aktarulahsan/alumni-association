                                ...
                                <div class="formcontainer">
                                    ...
                                    <c:if test="${!check}">
                                        <form:form name="addblog"
                                                   modelAttribute="skillinfo" action="addinaskill" 
                                                   method="post">
                                                ...
                                                <div class="form-group" hidden="true">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <form:input class="form-control"
                                                                    Placeholder="profile id " type="number" path="skillid"></form:input>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <form:textarea class="form-control"
                                                                       Placeholder="Java, JSTL, Angular Js, Android" type="text" path="skill" required="true"></form:textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button id="addeducation" name="EditBlog" class="btn btn-danger " type="submit">Add Skill</button>
