                                            ...
                                            <div>
                                                <ul class="nav nav-pills nav-stacked">
                                                    ...
                                                    <li> <a data-toggle="pill" href="#ski" class="list-group-item  text-center">
                                                        ...
                                                        <li> <a data-toggle="pill" href="#cob" class="list-group-item  text-center">
                                                            <h4 class="glyphicon glyphicon-star"></h4><br>Career Objective
                                                        </a></li>
                                            ...
                                            <div id="over" class="tab-pane fade in active   ">
                                                ...
                                                <div class="panel-body bio-graph-info">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="editalumniprofile"><button id="editbuttons"
                                                        ...
                                                        <form>
                                                            <div class="widget post panel-shadow animated fadeInUp">
                                                                ...
                                                                <div class=" panel-body bio-graph-info">
                                                                    ...
                                                                    <div class="pull-right">
                                                                        <a href="addalumnieducatoninfo"><button id="addeducation"
                                                                        ...
                                                                        <table class="table" ng-repeat="ox in education">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="pull-right">
                                                                                        <a href="editalumnieducation?getpid={{ox.eduinfoid}}"><button  id="editedu"
                                                                                                                                                       type="button" class="btn"><span class="glyphicon glyphicon-pencil"></span></button></a> 

                                                                                        <a href="removeestuducation/{{ox.eduinfoid}}"><button  id="removebuttons"
                                             ...
                                             <div id="cob" class="tab-pane fade ">
                                                <div class="panel-body bio-graph-info">
                                                    ...
                                                    <div>
                                                        <form>
                                                            <div class="widget post panel-shadow animated fadeInUp">
                                                                ...
                                                                <div class=" panel-body bio-graph-info">
                                                                    ...
                                                                    <h3 class="widget-caption">careerobjective</h3>

                                                                </div>
                                                                <div>
                                                                    <div>

                                                                        <table class="table" ng-repeat="cob in cobj">
                                                                            <thead>
                                                                                <tr>
                                                        ...
                                                        <div class="pull-right">
                                                            <a href="addcareerob"><button id="editbuttons"
                                                                                         type="submit" class="btn">Add Career Objective</button></a>
                                                        </div>
                                                    </div>
