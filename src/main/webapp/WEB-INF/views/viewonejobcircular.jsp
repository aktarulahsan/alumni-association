                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-heading">
                                                        <form:form name="addblog"
                                                                   modelAttribute="applyjob" action="applyjob" 
                                                                   method="post">
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group">
                                                                 ...
                                                                 <a href="applyjobs?getpid=${jobcicular.jobid}"><button id="editbuttons"
                                                                                          type="submit" class="btn">submit2</button></a> 
                                                                </div>
